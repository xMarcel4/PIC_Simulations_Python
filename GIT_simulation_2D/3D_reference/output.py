...
class Output:
    ...
    def fields_without_species_2d(world, filename_prefix, project_dir=""):
        ...
        try:
            with open(filename, 'w') as out:
                ...
                out.write(f'WholeExtent="0 {world.ni - 1} 0 {world.nj - 1}">\n')
                out.write('<PointData>\n')
                ...
                out.write(Output.field_data_to_string(world.objectid))  # Ensure the field itself is passed, not just the array
                out.write('</DataArray>\n')
                ...
                # Write the ef data with 2 components instead of 3 for 2D fields
    ...
    def screen_output(world, species_list):
        ...
        # Iterate through each species and print the name and number of particles
        for sp in species_list:
